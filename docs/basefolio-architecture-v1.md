# Basefolio — Architecture Document v1.0
...
| AI | Anthropic Claude API | Sonnet for narrative; Haiku for classification |
...
const MODEL_MAP: Record<AIModel, string> = {
  narrative: 'claude-sonnet-4-20250514', // Status Draft, portfolio narratives
